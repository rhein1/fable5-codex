...
Copy `templates/sol-ultra.config.toml` into your Codex configuration when you want the same coordinator and worker defaults in the app, IDE, and CLI. The plugin cannot silently replace the model or reasoning settings of an already-open task.
