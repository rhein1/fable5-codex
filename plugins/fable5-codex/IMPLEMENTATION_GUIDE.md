...
- Optional agent profiles live in `custom-agents/` and can be copied into a repo `.codex/agents/` directory.
...
5. Copy `AGENTS.snippet.md` into a repo only after confirming it does not conflict with that repo's policy.
